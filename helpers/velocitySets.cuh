...
static inline constexpr float W_0   = 1.0f / 3.0f; // 0
static inline constexpr float W0_45 = W_0 * 4.5f;
static inline constexpr float W_1   = 1.0f / 18.0f; // 1 to 6
static inline constexpr float W1_45 = W_1 * 4.5f;
static inline constexpr float W_2   = 1.0f / 36.0f; // 7 to 18
static inline constexpr float W2_45 = W_2 * 4.5f;

static inline constexpr idx_t FLINKS = 19;
...
static inline constexpr float W_0   = 8.0f / 27.0f; // 0
static inline constexpr float W0_45 = W_0 * 4.5f;
static inline constexpr float W_1   = 2.0f / 27.0f; // 1 to 6
static inline constexpr float W1_45 = W_1 * 4.5f;
static inline constexpr float W_2   = 1.0f / 54.0f; // 7 to 18
static inline constexpr float W2_45 = W_2 * 4.5f;
static inline constexpr float W_3   = 1.0f / 216.0f; // 19 to 26
static inline constexpr float W3_45 = W_3 * 4.5f;

static inline constexpr idx_t FLINKS = 27;
...
static inline constexpr float WG_0 = 1.0f / 4.0f; // 0
static inline constexpr float WG_1 = 1.0f / 8.0f; // 1 to 6

static inline constexpr idx_t GLINKS = 7;