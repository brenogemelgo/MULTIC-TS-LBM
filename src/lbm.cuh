...
void streamCollide(
    ...
    const float OMCO = 1.0f - omegaLocal;
    ...
    d.f[global4(x,y,z,0)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x+1,y,z,1)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y,z,2)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y+1,z,3)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y-1,z,4)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y,z+1,5)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y,z-1,6)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x+1,y+1,z,7)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y-1,z,8)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x+1,y,z+1,9)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y,z-1,10)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y+1,z+1,11)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y-1,z-1,12)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x+1,y-1,z,13)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y+1,z,14)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x+1,y,z-1,15)] = to_pop(feq + OMCO * fneqReg + forceCorr); 
    ...
    d.f[global4(x-1,y,z+1,16)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y+1,z-1,17)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x,y-1,z+1,18)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x+1,y+1,z+1,19)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y-1,z-1,20)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x+1,y+1,z-1,21)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y-1,z+1,22)] = to_pop(feq + OMCO * fneqReg + forceCorr);    
    ...
    d.f[global4(x+1,y-1,z+1,23)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y+1,z-1,24)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    ...
    d.f[global4(x-1,y+1,z+1,25)] = to_pop(feq + OMCO * fneqReg + forceCorr);    
    ...
    d.f[global4(x+1,y-1,z-1,26)] = to_pop(feq + OMCO * fneqReg + forceCorr);
    #endif 
}
